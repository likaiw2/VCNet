...
class ResUNet_LRes(nn.Module):
    def __init__(self, in_channel=1, out_channel=4, dp_prob=0):
        ...
        self.mid_dilated1 = Dilated_Block(hidden_channel*8,hidden_channel*8)
        self.mid_dilated2 = Dilated_Block(hidden_channel*8,hidden_channel*8)
        self.mid_dilated3 = Dilated_Block(hidden_channel*8,hidden_channel*8)
